...
import { ApiResponse, PasswordModel, PasswordFormProps } from "@/lib/types";
import { updatePassword } from "@/lib/actions/passwordActions";
import { showToastNotification } from "@/components/showToastNotification";
import { getPasswordScore } from "@/lib/utils";
...
export default function PasswordUpdateForm({
  ...
  return (
    <form action={formAction} className="space-y-6 form-container">
      <input type="hidden" name="id" value={currentPassword.id} />
