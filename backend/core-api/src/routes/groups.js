...
router.post('/:id/share', authenticate, async (req, res) => {
    try {
        ...
        const passwordIdExists = group.sharedPasswords.some(id => id.equals(passwordObjectId));
        ...
        const groupIdExists = password.sharedWith.some(id => id.equals(groupObjectId));
